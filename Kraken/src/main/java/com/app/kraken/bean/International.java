...
public class International {
	...
	public String toString() {
		return "International [carrier=" + carrier + ", modelno=" + modelno + ", departure_airport=" + departure_airport
				+ ", arrival_airport=" + arrival_airport + ", departure_date=" + departure_date + ", arrival_date="
				+ arrival_date + "]";
	}
	public International(String carrier, long modelno, String departure_airport, String arrival_airport,
